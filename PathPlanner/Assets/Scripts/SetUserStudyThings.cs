...
public class SetUserStudyThings : MonoBehaviour {
    ...
    void SetUserStudyParameters()
    {
        ...
        // Do this once for screen 0, once for screen 1 and once for screen 2
		if (ProjectConstants.pageIndex == 0)
		{
	        ...
	        str2 = str2 + "On the screen you will see a probability distribution map indicating likely places of finding the missing person \n(high hills indicate high probability). Some places are more difficulty to see the missing person due to vegetation \ndensity or lighting conditions. This information is presented as a task difficulty map to incidate how difficult it is for \nthe UAV to detect the missing person (red for very difficult, green for medium difficulty, and blue for easy).\n\n";
	        ...
	        str2 = str2 + "You will help plan paths for [9696FB]two WiSAR scenarios[FFFFFF] using [9696FB]three different planning modes[FFFFFF]: [9696FB]manual[FFFFFF], [9696FB]pattern[FFFFFF], and \n[9696FB]sliding autonomy[FFFFFF]. But first let's practice how to use the three planning modes to plan UAV paths.";
	        ...
	        str3 = str3 + "Please follow instructions on screen. You have [9696FB]4 minutes[FFFFFF] to complete the exercise.";
	        ...
	        ProjectConstants.durations.Add(4);
	        ProjectConstants.nextScene.Add("UserStudy");
	        ProjectConstants.diffMaps.Add("");
	        ...
	        str5 = str5 + "Please follow instructions on screen. You have [9696FB]4 minutes[FFFFFF] to complete the exercise.";
	        ...
	        str7 = str7 + "Please follow instructions on screen. You have [9696FB]4 minutes[FFFFFF] to complete the exercise.";
	        ...
	        str9 = str9 + "Please follow instructions on screen. You have [9696FB]4 minutes[FFFFFF] to complete the exercise.";
        ...
        else if(ProjectConstants.pageIndex == 1)
        {
            ...
            strM1 = strM1 + "In this scenario, you will use the [9696FB]manual planning mode[FFFFFF] to plan a UAV path for a [9696FB]60-minute[FFFFFF] flight. \n[9696FB]No task difficulty map is used[FFFFFF] in this exercise.\n\n";
            ...
            strP1 = strP1 + "In this scenario, you will use the [9696FB]pattern planning mode[FFFFFF] to plan a UAV path for a [9696FB]60-minute[FFFFFF] flight. \n[9696FB]No task difficulty map is used[FFFFFF] in this exercise.\n\n";
            ...
            strS1 = strS1 + "In this scenario, you will use the [9696FB]sliding autonomy planning mode[FFFFFF] to plan a UAV path for a [9696FB]60-minute[FFFFFF] flight. \n[9696FB]No task difficulty map is used[FFFFFF] in this exercise.\n\n";
            ...
            strMD1 = strMD1 + "In this scenario, you will use the [9696FB]manual planning mode[FFFFFF] to plan a UAV path for a [9696FB]60-minute[FFFFFF] flight.\n\n";
            ...
            strPD1 = strPD1 + "In this scenario, you will use the [9696FB]pattern planning mode[FFFFFF] to plan a UAV path for a [9696FB]60-minute[FFFFFF] flight.\n\n";
            ...
            strSD1 = strSD1 + "In this scenario, you will use the [9696FB]sliding autonomy planning mode[FFFFFF] to plan a UAV path for a [9696FB]60-minute[FFFFFF] flight.\n\n";
